...
{
    internal class OfficeMobile2014ColorTableInitializer
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            table.SystemButton.MouseOver.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorDark));
            ...
            table.SystemButton.Pressed.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorDarker));
            ...
            table.SystemButtonClose.MouseOver.Foreground = new LinearGradientColorTable(Color.White);
            ...
            table.SystemButtonClose.Pressed.Foreground = new LinearGradientColorTable(factory.GetColor(Color.White));
            ...
            sl.Default.PartForeColor = factory.GetColor(metroColors.TextColor);
            sl.Default.PartForeLightColor = Color.Empty;
            sl.Default.TrackLineColor = factory.GetColor(metroColors.TextColor);
            ...
            sl.MouseOver.TrackLineColor = factory.GetColor(metroColors.TextColor);
            ...
            sl.TrackPart.Default.LabelColor = factory.GetColor(metroColors.TextColor);
            sl.TrackPart.Default.SliderLabelColor = factory.GetColor(metroColors.TextColor);
            sl.TrackPart.Default.PartBackground = new GradientColorTable(factory.GetColor(metroColors.TextColor));
            sl.TrackPart.Default.PartBorderColor = factory.GetColor(metroColors.TextColor);
            sl.TrackPart.Default.PartBorderLightColor = Color.Empty;
            sl.TrackPart.Default.PartForeColor = factory.GetColor(metroColors.TextColor);
            sl.TrackPart.Default.PartForeLightColor = factory.GetColor(metroColors.TextColor);
            sl.TrackPart.Default.TrackLineColor = factory.GetColor(metroColors.TextColor);
            ...
            sl.TrackPart.MouseOver.TrackLineColor = factory.GetColor(metroColors.TextColor);
            ...
            // TabFormPanel
            style = Office2007ColorTableFactory.GetTabFormPanelStyle(ribbonBack);
            table.StyleClasses.Add(style.Class, style);
            ...
            #region TabForm
            table.TabForm.CaptionTextFormat|= eTextFormat.HorizontalCenter;
        ...
        public static Office2007RibbonTabGroupColorTable GetRibbonTabGroupDefault(ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            tg.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
        ...
        public static Office2007RibbonTabGroupColorTable GetRibbonTabGroupOrange(ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            tg.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            tg.BackgroundHighlight = LinearGradientColorTable.Empty;
            tg.Text = factory.GetColor(0xFF9D00);
