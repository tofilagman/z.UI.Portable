...
namespace DevComponents.DotNetBar.Metro.ColorTables
{
    internal class VisualStudio2012OfficeColorTableInitializer
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            table.LegacyColors.ItemExpandedBackground = factory.GetColor(metroColors.CanvasColorLightShade);
            ...
            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(metroColors.TextColor);
            table.TabForm.Inactive.CaptionText = factory.GetColor(metroColors.TextLightColor);
            table.TabForm.Active.CaptionBackColors = new Color[] { factory.GetColor(metroColors.CanvasColor) };
            table.TabForm.Inactive.CaptionBackColors = new Color[] { factory.GetColor(metroColors.CanvasColor) };
        ...
        public static Office2007ButtonItemColorTable GetButtonItemDefaultWithBackground(ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            cb.Disabled.InnerBorder = LinearGradientColorTable.Empty;
