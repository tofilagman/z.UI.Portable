...
{
    internal class Office2016ColorTableInitializer
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            Color ribbonBack = factory.GetColor(metroColors.CanvasColorLight);
            ...
            table.RibbonControl.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            ...
            table.RibbonControl.TabsBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            ...
            table.ContextualTables.Add(Office2007ColorTable.GetContextualKey(typeof(Office2007ButtonItemColorTable), "MetroTabStrip"), GetButtonItemStatusBar(factory, metroColors));
            table.ContextualTables.Add(Office2007ColorTable.GetContextualKey(typeof(Office2007ButtonItemColorTable), "NavigationBar"), GetButtonItemNavigationBar(factory, metroColors));
            #endregion
            ...
            table.SystemButton.Default.Foreground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseTextColor));
            ...
            table.SystemButton.MouseOver.Foreground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseTextColor));
            table.SystemButton.MouseOver.LightShade = Color.Empty;
            table.SystemButton.MouseOver.DarkShade = Color.Empty;
            table.SystemButton.MouseOver.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorLight1));
            ...
            table.SystemButton.Pressed.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorDark));
            ...
            table.SystemButtonClose.Default.Foreground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseTextColor));
            ...
            table.SystemButtonClose.MouseOver.Foreground = new LinearGradientColorTable(factory.GetColor(Color.White));
            table.SystemButtonClose.MouseOver.LightShade = Color.Empty;
            table.SystemButtonClose.MouseOver.DarkShade = Color.Empty;
            table.SystemButtonClose.MouseOver.TopBackground = new LinearGradientColorTable(factory.GetColor(0xE81123));
            ...
            table.SystemButtonClose.Pressed.Foreground = new LinearGradientColorTable(factory.GetColor(Color.Black));
            table.SystemButtonClose.Pressed.LightShade = Color.Empty;
            table.SystemButtonClose.Pressed.DarkShade = Color.Empty;
            table.SystemButtonClose.Pressed.TopBackground = new LinearGradientColorTable(factory.GetColor(0xF1707A)); ;
            ...
            // Form Caption Active
            table.Form.Active.CaptionTopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.Form.Active.CaptionBottomBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.Form.Active.CaptionBottomBorder = null;
            table.Form.Active.CaptionText = factory.GetColor(metroColors.BaseTextColor);
            table.Form.Active.CaptionTextExtra = factory.GetColor(metroColors.BaseTextColor);

            // Form Caption Inactive
            table.Form.Inactive.CaptionTopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.Form.Inactive.CaptionBottomBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.Form.Inactive.CaptionText = factory.GetColor(metroColors.BaseColorLightText);
            table.Form.Inactive.CaptionTextExtra = factory.GetColor(metroColors.BaseColorLightText);
            ...
            table.TabControl.MouseOver.OuterBorder = factory.GetColor(metroColors.BaseColorLight1);
            table.TabControl.MouseOver.Text = metroColors.TextColor;
            ...
            table.LegacyColors.BarBackground = factory.GetColor(metroColors.CanvasColorLight);
            ...
            table.LegacyColors.PanelBorder = factory.GetColor(metroColors.CanvasColorLightShade);
            ...
            sbt.OnBackColor = factory.GetColor(metroColors.BaseColorDark);
            sbt.OnTextColor = factory.GetColor(metroColors.BaseTextColor);
            sbt.SwitchBackColor = factory.GetColor(metroColors.BaseColorDark);
            ...
            table.SwitchButton.Disabled.OffTextColor = factory.GetColor(160,metroColors.TextColor);
            table.SwitchButton.Disabled.OnTextColor = factory.GetColor(160, metroColors.TextColor); ;
            table.SwitchButton.Disabled.TextColor = factory.GetColor(160, metroColors.TextColor); ;
            ...
            table.StyleClasses.Add(style.Class, style);
            // ListBoxAdv
            style = Office2007ColorTableFactory.GetListBoxAdvStyle(factory.GetColor(metroColors.CanvasColorDarkShade), factory.GetColor(metroColors.CanvasColor));
            table.StyleClasses.Add(style.Class, style);
            ...
            style = Office2007ColorTableFactory.GetProgressStepsStyle(table);
            table.StyleClasses.Add(style.Class, style);

            // SideNavStrip
            style = Office2007ColorTableFactory.GetSideNavStripStyle(metroColors.BaseColor);
            table.StyleClasses.Add(style.Class, style);
            ...
            style = Office2007ColorTableFactory.GetToolboxControlStyle(factory.GetColor(metroColors.CanvasColorDarkShade), Color.Empty);
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitle(factory.GetColor(metroColors.TextColor));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(metroColors.BaseColorLightText), factory.GetColor(metroColors.BaseColorLightest));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(metroColors.BaseTextColor), factory.GetColor(metroColors.BaseColor));
            table.StyleClasses.Add(style.Class, style);
            #endregion
            ...
            table.LabelItemColors.Add(Office2007ColorTable.GetContextualKey(typeof(Bar)), new LabelColors(factory.GetColor(metroColors.TextColor), factory.GetColor(metroColors.TextDisabledColor)));
            table.LabelItemColors.Add(Office2007ColorTable.GetContextualKey(typeof(Bar), "StatusBar"), new LabelColors(factory.GetColor(metroColors.BaseTextColor), factory.GetColor(metroColors.TextDisabledColor)));
            #endregion
            ...
            table.RadialMenu.RadialMenuItemDisabledForeground = factory.GetColor(metroColors.TextDisabledColor);
            ...
            #region StepItem
            table.StepItem.Default = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(metroColors.CanvasColor)
                    },
                    90,
                    new float[0],
                factory.GetColor(metroColors.TextColor),
                new Color[] {
                    factory.GetColor(metroColors.CanvasColorDarkShade) });
            table.StepItem.Progress = new OfficeStepItemStateColorTable(new Color[]{
                ...
                Color.Empty,
                new Color[0]);
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(metroColors.CanvasColorLight)
                    },
                    90,
                    new float[0],
                factory.GetColor(metroColors.TextColor),
                new Color[] {
                    factory.GetColor(metroColors.CanvasColorLight) });
            table.StepItem.Pressed = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(metroColors.BaseColor)
                    },
                    90,
                    new float[0],
                factory.GetColor(metroColors.BaseTextColor),
                new Color[] {
                    factory.GetColor(metroColors.BaseColor) });
            #endregion

            #region TokenEditor
            table.TokenEditor = new TokenEditorColorTable(metroColors.TextColor, metroColors.CanvasColorLighterShade, metroColors.TextColor, metroColors.CanvasColorLightShade, metroColors.BaseTextColor, metroColors.BaseColor);
            #endregion

            #region Flyout
            table.Flyout.BorderColor = metroColors.BaseColor;
            table.Flyout.BackColor = metroColors.CanvasColor;
            #endregion

            #region SideNav
            table.SideNav.SideNavItem.Default = new SideNavItemStateColorTable(factory.GetColor(metroColors.BaseTextColor));
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(metroColors.BaseColorLightText),
                new Color[]
                {
                    factory.GetColor(metroColors.BaseColorLight)
                },
                new Color[] { factory.GetColor(metroColors.BaseColorLight) },
                0);
            table.SideNav.SideNavItem.Pressed = new SideNavItemStateColorTable(factory.GetColor(metroColors.BaseColorLightText),
                new Color[]
                {
                    factory.GetColor(metroColors.BaseColorDark)
                },
                new Color[] { factory.GetColor(metroColors.BaseColorDark) },
                0);
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(metroColors.TextColor),
                new Color[] { factory.GetColor(metroColors.CanvasColor) },
                new Color[] { Color.Empty, factory.GetColor(metroColors.CanvasColor), Color.Empty, factory.GetColor(metroColors.CanvasColor) });
            table.SideNav.BorderColors = new Color[] { factory.GetColor(metroColors.BaseColor) };
            table.SideNav.TitleBackColor = factory.GetColor(metroColors.BaseColorDark);
            table.SideNav.TitleBorderColors = new Color[] { Color.Empty, Color.Empty, Color.Empty, factory.GetColor(metroColors.BaseColor) };
            table.SideNav.PanelBackColor = table.Form.BackColor;

            #endregion

            #region TabForm
            table.TabForm.CaptionTextFormat = eTextFormat.VerticalCenter | eTextFormat.HorizontalCenter | eTextFormat.EndEllipsis | eTextFormat.NoPrefix;
            table.TabForm.Active.CaptionText = factory.GetColor(metroColors.BaseTextColor);
            table.TabForm.Inactive.CaptionText = factory.GetColor(metroColors.BaseTextColor);
            table.TabForm.Active.CaptionBackColors = new Color[] { factory.GetColor(metroColors.BaseColor) };
            table.TabForm.Inactive.CaptionBackColors = new Color[] { factory.GetColor(metroColors.BaseColor) };
            table.TabFormItemColorTables.Clear();
            table.TabFormItemColorTables.Add(TabFormItem.DefaultColorTableKey,
                Office2007ColorTable.CreateDefaultTabFormItemColorTable(factory,
                new Color[] { factory.GetColor(metroColors.CanvasColorLighterShade) },
                new Color[] { factory.GetColor(metroColors.CanvasColorLightShade) },
                factory.GetColor(metroColors.TextLightColor),
                new Color[] { factory.GetColor(ribbonBack) },
                new Color[] { factory.GetColor(metroColors.CanvasColorLightShade) },
                factory.GetColor(metroColors.BaseColor)
                ));
            table.TabFormItemColorTables.Add(TabFormItem.BlueColorTableKey, Office2007ColorTable.CreateBlueTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.YellowColorTableKey, Office2007ColorTable.CreateYellowTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.PurpleColorTableKey, Office2007ColorTable.CreatePurpleTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.CyanColorTableKey, Office2007ColorTable.CreateCyanTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.BlueMistColorTableKey, Office2007ColorTable.CreateBlueMistTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.PurpleMistColorTableKey, Office2007ColorTable.CreatePurpleMistTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.TanColorTableKey, Office2007ColorTable.CreateTanTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.LemonLimeColorTableKey, Office2007ColorTable.CreateLemonLimeTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.AppleColorTableKey, Office2007ColorTable.CreateAppleTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.TealColorTableKey, Office2007ColorTable.CreateTealTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.RedChalkColorTableKey, Office2007ColorTable.CreateRedChalkTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.SilverColorTableKey, Office2007ColorTable.CreateSilverTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.OrangeColorTableKey, Office2007ColorTable.CreateOrangeTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.GreenColorTableKey, Office2007ColorTable.CreateGreenTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.MagentaColorTableKey, Office2007ColorTable.CreateMagentaTabFormItemColorTable(factory));
            table.TabFormItemColorTables.Add(TabFormItem.RedColorTableKey, Office2007ColorTable.CreateRedTabFormItemColorTable(factory));
            #endregion
        ...
        public static Office2007ButtonItemColorTable GetButtonItemDefault(ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            cb.MouseOver.BottomBackground = null;
            cb.MouseOver.BottomBackgroundHighlight = null;
            cb.MouseOver.Background = new LinearGradientColorTable(metroColors.CanvasColorLightShade);
            cb.MouseOver.InnerBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLightShade));// LinearGradientColorTable.Empty;
            cb.MouseOver.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorDarkShade));
            ...
            // Pressed
            cb.Pressed = new Office2007ButtonItemStateColorTable();
            cb.Pressed.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorDarkerShade));
            cb.Pressed.InnerBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorDarkerShade));
            cb.Pressed.Background = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorDarkerShade));
            ...
            cb.Checked.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorDarkerShade));
            cb.Checked.InnerBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorDarkShade));
            cb.Checked.Background = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorDarkShade));
        ...
        public static Office2007ButtonItemColorTable GetButtonItemNavigationBar(ColorFactory factory, MetroPartColors metroColors)
        {
            Office2007ButtonItemColorTable cb = new Office2007ButtonItemColorTable();
            cb.Default = new Office2007ButtonItemStateColorTable();
            cb.Default.Text = factory.GetColor(metroColors.TextColor);
            ...
            // Checked
            cb.Checked = new Office2007ButtonItemStateColorTable();
            cb.Checked.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            cb.Checked.InnerBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            cb.Checked.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            cb.Checked.TopBackground = null;
            cb.Checked.TopBackgroundHighlight = null;
            cb.Checked.BottomBackground = null;
        ...
        public static Office2007RibbonTabItemColorTable GetRibbonTabItemBlueDefault(ColorFactory factory, MetroPartColors metroColors, Color ribbonBack)
        {
            ...
            rt.Default.Text = factory.GetColor(metroColors.CanvasColor);
            rt.CornerSize = 0;
            ...
            rt.Selected.OuterBorder = new LinearGradientColorTable(metroColors.BaseColor);
            ...
            rt.SelectedMouseOver.OuterBorder = new LinearGradientColorTable(metroColors.BaseColor);
            rt.SelectedMouseOver.Text = factory.GetColor(metroColors.BaseColor);

            // Tab Mouse Over
            rt.MouseOver = new Office2007RibbonTabItemStateColorTable();
            rt.MouseOver.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorLight1));
            ...
            rt.MouseOver.Text = factory.GetColor(metroColors.CanvasColor);
        ...
        public static void InitializeScrollBarColorTable(Office2007ScrollBarColorTable scrollBarColorTable, ColorFactory factory, MetroPartColors metroParts)
        {
            ...
            sct.ThumbOuterBorder = new LinearGradientColorTable(factory.GetColor(metroParts.CanvasColorLightShade));
            sct.TrackBackground.Clear();
            sct.TrackInnerBorder = LinearGradientColorTable.Empty;
            sct.TrackOuterBorder = new LinearGradientColorTable(factory.GetColor(metroParts.CanvasColorLightShade));
            sct.TrackSignBackground = new LinearGradientColorTable(factory.GetColor(metroParts.CanvasColor));
            ...
            sct.TrackInnerBorder = LinearGradientColorTable.Empty;
            sct.TrackOuterBorder = new LinearGradientColorTable(factory.GetColor(metroParts.CanvasColorLightShade));
            sct.TrackSignBackground = new LinearGradientColorTable(factory.GetColor(metroParts.CanvasColorLighterShade));
            ...
            sct.ThumbBackground.Clear();
            sct.ThumbInnerBorder = LinearGradientColorTable.Empty;
            sct.ThumbOuterBorder = new LinearGradientColorTable(factory.GetColor(metroParts.TextInactiveColor));
            sct.ThumbSignBackground = new LinearGradientColorTable(factory.GetColor(metroParts.TextInactiveColor));
            sct.TrackBackground.Clear();
            sct.TrackInnerBorder = LinearGradientColorTable.Empty;
            sct.TrackOuterBorder = new LinearGradientColorTable(factory.GetColor(metroParts.TextInactiveColor));
            sct.TrackSignBackground = new LinearGradientColorTable(factory.GetColor(metroParts.CanvasColorLighterShade));
            // Disabled
        ...
        public static Office2007RibbonTabGroupColorTable GetRibbonTabGroupDefault(ColorFactory factory, MetroPartColors metroColors)
        {
            Office2007RibbonTabGroupColorTable tg = new Office2007RibbonTabGroupColorTable();
            tg.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorDark));
            tg.BackgroundHighlight = LinearGradientColorTable.Empty;
            tg.Text = factory.GetColor(metroColors.BaseColorLighter);
            tg.Border = LinearGradientColorTable.Empty;

            return tg;
        }

        public static Office2007RibbonTabGroupColorTable GetRibbonTabGroupOrange(ColorFactory factory, MetroPartColors metroColors)
        {
            Office2007RibbonTabGroupColorTable tg = new Office2007RibbonTabGroupColorTable();
            tg.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorDark));
            tg.BackgroundHighlight = LinearGradientColorTable.Empty;
        ...
        public static Office2007RibbonTabGroupColorTable GetRibbonTabGroupMagenta(ColorFactory factory, MetroPartColors metroColors)
        {
            Office2007RibbonTabGroupColorTable tg = new Office2007RibbonTabGroupColorTable();
            tg.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorDark));
            tg.BackgroundHighlight = LinearGradientColorTable.Empty;
        ...
        public static Office2007RibbonTabGroupColorTable GetRibbonTabGroupGreen(ColorFactory factory, MetroPartColors metroColors)
        {
            Office2007RibbonTabGroupColorTable tg = new Office2007RibbonTabGroupColorTable();
            tg.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorDark));
            tg.BackgroundHighlight = LinearGradientColorTable.Empty;
