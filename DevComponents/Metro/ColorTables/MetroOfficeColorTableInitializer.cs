    ...
    internal static class MetroOfficeColorTableInitializer
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(metroColors.BaseColorLightest)
                    },
                    90,
                    new float[0],
                factory.GetColor(metroColors.BaseColorLightText),
                new Color[] {
                    factory.GetColor(metroColors.BaseColorLightest) });
            ...
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(metroColors.BaseColorLightText),
                ...
                0);
            table.SideNav.SideNavItem.Pressed = new SideNavItemStateColorTable(factory.GetColor(metroColors.BaseTextColor),
                new Color[]
                {
                ...
                0);
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(metroColors.BaseTextColor),
                new Color[] { factory.GetColor(metroColors.BaseColorDark) },
                new Color[] { Color.Empty, factory.GetColor(metroColors.BaseColorDark), Color.Empty, factory.GetColor(metroColors.BaseColorDark) });
            table.SideNav.BorderColors = new Color[] { factory.GetColor(metroColors.BaseColorDark) };
            table.SideNav.TitleBackColor = factory.GetColor(metroColors.BaseColorDark);
            table.SideNav.TitleBorderColors = new Color[] { Color.Empty, Color.Empty, Color.Empty, factory.GetColor(metroColors.BaseColorDark) };
            table.SideNav.PanelBackColor = table.Form.BackColor;

            #endregion

            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(metroColors.TextLightColor);
