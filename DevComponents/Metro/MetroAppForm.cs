    ...
    public class MetroAppForm : Form
    {
        ...
        protected virtual bool WindowsMessageNCHitTest(ref Message m)
        {
            ...
            if (this.Sizable && !borderResize.IsZero && this.WindowState == FormWindowState.Normal)
            {
                ...
                hitTest = new Rectangle(this.Width - ((int)borderResize.Right+Dpi.Width10), this.Height - ((int)borderResize.Bottom+Dpi.Height10), (int)borderResize.Right+Dpi.Width10, (int)borderResize.Bottom+Dpi.Height10); hitTest.Inflate(2, 2);
                if (hitTest.Contains(p))
                {
