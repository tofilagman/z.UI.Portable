...
namespace DevComponents.DotNetBar
{
   ...
   System.Runtime.InteropServices.ComVisible(false), Designer("DevComponents.DotNetBar.Design.SuperTooltipDesigner, DevComponents.DotNetBar.Design, Version=14.1.0.25, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
    public class SuperTooltip : Component , IExtenderProvider
    {
        ...
        /// </summary>
        [Localizable(true), Editor("DevComponents.DotNetBar.Design.SuperTooltipInfoEditor, DevComponents.DotNetBar.Design, Version=14.1.0.25, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor)), DefaultValue(null), Description("Indicates default setting for new Tooltips you create in design time.")]
		...
		/// </summary>
        [Editor("DevComponents.DotNetBar.Design.SuperTooltipInfoEditor, DevComponents.DotNetBar.Design, Version=14.1.0.25, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor)), DefaultValue(null), Localizable(true)]
        ...
        public void SetSuperTooltip(IComponent c, SuperTooltipInfo info)
        {
            ...
            else if (c is NumericUpDown && !this.DesignMode)
            {
                NumericUpDown num = (NumericUpDown)c;
                foreach (Control item in num.Controls)
                {
                    SetSuperTooltip(item, info);
                }
            }
#endif
        }
        ...
        private void ShowTooltip(object sender, Point screenPosition, bool useScreenPosition)
        {
            ...
            if (BeforeTooltipDisplay != null)
            {
                ...
                eventArgs.TooltipSize = tooltipSize;
    ...
    /// </summary>
    [TypeConverter("DevComponents.DotNetBar.Design.SuperTooltipInfoConverter, DevComponents.DotNetBar.Design, Version=14.1.0.25, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf"), DesignTimeVisible(false), ToolboxItem(false), Localizable(true)]
