namespace DevComponents.DotNetBar
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(Bar), "Bar.ico"), ToolboxItem(true), Designer("DevComponents.DotNetBar.Design.BarDesigner, DevComponents.DotNetBar.Design, Version=14.1.0.25, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf"), System.Runtime.InteropServices.ComVisible(false), DefaultEvent("ItemClick")]
        ...
        ICustomSerialization, IRenderingSupport, IAccessibilitySupport, IOwnerLocalize
    {
        ...
        protected override void ScaleControl(SizeF factor, BoundsSpecified specified)
        {
            ...
            m_SystemButtons.ButtonSize = Dpi.Size(m_SystemButtons.ButtonSize);
        ...
        {
            List<BaseItem> hiddenList = new List<BaseItem>();
            foreach (BaseItem item in m_ItemContainer.SubItems)
            {
                if (!item.Visible)
                    hiddenList.Add(item);
