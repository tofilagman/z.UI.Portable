...
namespace DevComponents.DotNetBar.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(Slider), "Controls.Slider.ico"), ToolboxItem(true), DefaultEvent("ValueChanged"), ComVisible(false), Designer("DevComponents.DotNetBar.Design.SliderDesigner, DevComponents.DotNetBar.Design, Version=14.1.0.25, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
    public class Slider : BaseItemControl, ICommandSource
    {
        ...
        public DevComponents.DotNetBar.Rendering.Office2007SliderColorTable ColorTable
        {
            get
            {
                return m_Slider.ColorTable;
            }
            set
            {
                m_Slider.ColorTable = value;
            }
        }
        #endregion
