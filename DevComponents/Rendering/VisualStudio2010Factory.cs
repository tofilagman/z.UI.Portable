...
namespace DevComponents.DotNetBar.Rendering
{
    internal static class VisualStudio2010Factory
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            // SideNavStrip
            style = Office2007ColorTableFactory.GetSideNavStripStyle(factory.GetColor(0xBCC7D8));
            table.StyleClasses.Add(style.Class, style);
            // TabFormPanel
            style = Office2007ColorTableFactory.GetTabFormPanelStyle(factory.GetColor(0xCAD3E2));
            table.StyleClasses.Add(style.Class, style);

            // Toolbox Control
            style = Office2007ColorTableFactory.GetToolboxControlStyle(factory.GetColor(table.LegacyColors.PanelBorder), Color.Empty);
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitle(factory.GetColor(0x1B293E));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(0x1B293E), factory.GetColor(0xFFECB5));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(0x1B293E), factory.GetColor(0xAEB9CD));
            table.StyleClasses.Add(style.Class, style);
            #endregion
            ...
            table.StepItem.Default = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xCAD3E2), 
                    factory.GetColor(0xAEB9CD)
                    },
                    90,
                    new float[0],
                factory.GetColor(0x1B293E),
                new Color[] {
                    factory.GetColor(0x8894A8) });
            ...
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xFFFCF2), 
                    factory.GetColor(0xFFF3CF),
                    factory.GetColor(0xFFECB5), 
                    factory.GetColor(0xFFECB5)
                    },
                    90,
            ...
            #region SideNav
            table.SideNav.SideNavItem.Default = new SideNavItemStateColorTable(factory.GetColor(0x1B293E));
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(0x1B293E),
                new Color[]
                {
                    factory.GetColor(0xFFFCF2), factory.GetColor(0xFFF3CF), factory.GetColor(0xFFECB5),
                    factory.GetColor(0xFFECB5)
                },
                new Color[] { factory.GetColor(0xE5C365) },
                0);
            table.SideNav.SideNavItem.Pressed = new SideNavItemStateColorTable(factory.GetColor(0x1B293E),
                new Color[]
                {
                    factory.GetColor(0xFFE8A6), factory.GetColor(0xFFE8A6)
                },
                new Color[] { factory.GetColor(0xE5C365) },
                0);
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(0x1B293E),
                new Color[] { table.Form.BackColor },
                new Color[] { Color.Empty, factory.GetColor(0x8894A8), Color.Empty, factory.GetColor(0x8894A8) });
            table.SideNav.BorderColors = new Color[] { factory.GetColor(0x8894A8) };
            table.SideNav.TitleBackColor = factory.GetColor(0xCAD3E2);
            ...
            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(0x1B293E);
            table.TabForm.Inactive.CaptionText = factory.GetColor(0x1B293E);
            table.TabForm.Active.CaptionBackColors = new Color[] { factory.GetColor(0xBCC7D8) };
            table.TabForm.Inactive.CaptionBackColors = new Color[] { factory.GetColor(0xBCC7D8) };
            ...
            table.TabFormItemColorTables.Add(TabFormItem.DefaultColorTableKey,
                ...
                new Color[] { factory.GetColor(0x8894A8) },
                factory.GetColor(0x1B293E),
                new Color[] { factory.GetColor(0xCAD3E2)},
                new Color[] { factory.GetColor(0x8894A8) },
                factory.GetColor(0x1B293E)
                ));
