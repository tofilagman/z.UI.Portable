...
namespace DevComponents.DotNetBar.Rendering
{
    internal class Office2007ColorTableFactory
    {
        ...
        public static void InitializeVistaBlackColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            // SideNavStrip
            style = Office2007ColorTableFactory.GetSideNavStripStyle(factory.GetColor(0x535353));
            table.StyleClasses.Add(style.Class, style);
            ...
            // Toolbox Control
            style = Office2007ColorTableFactory.GetToolboxControlStyle(factory.GetColor(table.LegacyColors.PanelBorder), Color.Empty);
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitle(factory.GetColor(0x000000));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(0x000000), factory.GetColor(0xDDCF9B));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(0x000000), factory.GetColor(0xB6B8B8));
            table.StyleClasses.Add(style.Class, style);            
            #endregion
            ...
            table.RadialMenu.RadialMenuItemDisabledForeground = factory.GetColor(0x8D8D8D);
            ...
            table.StepItem.Default = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xF8F8F9), 
                    factory.GetColor(0xDFE2E4), 
                    factory.GetColor(0xC7CBD1), 
                    factory.GetColor(0xDBDEE2)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x000000),
                new Color[] {
                    factory.GetColor(0x898785) });
            ...
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                ...
                factory.GetColor(0x000000),
                new Color[] {
                    factory.GetColor(0xDDCF9B) });
            table.StepItem.Pressed = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xF8B56A), 
                    factory.GetColor(0xFCA060),
                    factory.GetColor(0xFB8A3C), 
                    factory.GetColor(0xFEBD62)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x000000),
                new Color[] {
                    factory.GetColor(0x8B7654) });
            #endregion

            #region ListBoxItem
            table.ListBoxItem.Default = new OfficeListBoxItemStateColorTable(factory.GetColor(0x000000));
            table.ListBoxItem.MouseOver = new OfficeListBoxItemStateColorTable(factory.GetColor(0x000000), new Color[]{
                    factory.GetColor(0xFFFCD9),
                    factory.GetColor(0xFFE793)
                    },
                    90,
                    new float[] { 0f, 1f });
            table.ListBoxItem.Selected = new OfficeListBoxItemStateColorTable(factory.GetColor(0x000000), new Color[]{
            ...
            #region TokenEditor
            table.TokenEditor = new TokenEditorColorTable(0xFFFFFF, 0x3C4251, 0xFFFFFF, 0x1C1E26, 0xFFFFFF, 0x2F5EA9);
            #endregion

            #region Flyout
            table.Flyout.BorderColor = table.Form.Active.BorderColors[0];
            #endregion

            #region SideNav
            table.SideNav.SideNavItem.Default = new SideNavItemStateColorTable(factory.GetColor(0x000000));
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(0x000000),
                new Color[]
                {
                ...
                2);
            table.SideNav.SideNavItem.Pressed = new SideNavItemStateColorTable(factory.GetColor(0x000000),
                new Color[]
                {
                ...
                2);
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(0x000000),
                new Color[] { table.Form.BackColor },
                new Color[] { Color.Empty, factory.GetColor(0xBEBEBE), Color.Empty, factory.GetColor(0xBEBEBE) });
            table.SideNav.BorderColors = new Color[] { factory.GetColor(0xBEBEBE) };
            table.SideNav.TitleBackColor = factory.GetColor(0x414141);
            table.SideNav.TitleBorderColors = new Color[] { Color.Empty, Color.Empty, Color.Empty, factory.GetColor(0xBEBEBE) };
            table.SideNav.PanelBackColor = table.Form.BackColor;

            #endregion

            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(0x000000);
            table.TabForm.Inactive.CaptionText = factory.GetColor(0x7D7D7D);
            table.TabForm.Active.CaptionBackColors = new Color[] { factory.GetColor(0xF5F6F7) };
            table.TabForm.Inactive.CaptionBackColors = new Color[] { factory.GetColor(0xF5F6F7) };
            table.TabFormItemColorTables.Add(TabFormItem.DefaultColorTableKey, Office2007ColorTable.CreateDefaultTabFormItemColorTable(factory, 0x000000));
        ...
        public static ElementStyle GetListBoxAdvStyle(Color borderColor, Color backColor)
        {
            ElementStyle style = new ElementStyle();
            style.Class = ElementStyleClassKeys.ListBoxAdvKey;
            style.BorderColor = borderColor;
            style.BorderWidth = 1;
            style.Border = eStyleBorderType.Solid;
            style.PaddingLeft = 1;
        ...
        public static ElementStyle GetListBoxAdvStyle(Color borderColor)
        {
            return GetListBoxAdvStyle(borderColor, Color.White);
        }
        ...
        public static ElementStyle GetProgressStepsStyle(DevComponents.DotNetBar.Rendering.Office2007ColorTable table)
        {
            ElementStyle style = new ElementStyle(ElementStyleClassKeys.ProgressStepsKey);
            style.BackColor = table.Form.BackColor;
            //style.BackColor2 = table.Form.BackColor
            //style.BackColorGradientAngle = table.LegacyColors.BarBackgroundGradientAngle;
            return style;
        }

        public static ElementStyle GetSideNavStripStyle(DevComponents.DotNetBar.Rendering.Office2007ColorTable table)
        {
            ElementStyle style = new ElementStyle(ElementStyleClassKeys.SideNavStripKey);
            style.BackColor = table.RibbonControl.TabDividerBorder;
            return style;
        }
        public static ElementStyle GetSideNavStripStyle(Color backColor)
        {
            ElementStyle style = new ElementStyle(ElementStyleClassKeys.SideNavStripKey);
            style.BackColor = backColor;
            return style;
        }
        public static ElementStyle GetTabFormPanelStyle(Color backColor)
        {
            ElementStyle style = new ElementStyle(ElementStyleClassKeys.TabFormPanelKey);
            style.BackColor = backColor;
            return style;
        }
        #endregion

        #region Toolbox Control ElementStyle
        public static ElementStyle GetToolboxControlStyle(Color borderColor, Color backColor)
        {
            ElementStyle style = new ElementStyle();
            style.Class = ElementStyleClassKeys.ToolboxControlKey;
            style.BorderColor = borderColor;
            style.BorderWidth = 1;
            style.Border = eStyleBorderType.Solid;
            style.BackColor = backColor;
        ...
        private const int ToolboxGroupPadding = 5;
        public static ElementStyle GetToolboxGroupTitle(Color textColor)
        {
            ElementStyle style=new ElementStyle(textColor);
            style.Class = ElementStyleClassKeys.ToolboxGroupTitleKey;
            style.PaddingBottom = ToolboxGroupPadding;
            style.PaddingTop = ToolboxGroupPadding;
            style.PaddingLeft = ToolboxGroupPadding;
            style.PaddingRight = ToolboxGroupPadding;
            style.MarginBottom = ToolboxGroupPadding;
            return style;
        }

        public static ElementStyle GetToolboxGroupTitleMouseOver(Color textColor, Color backColor)
        {
            ElementStyle style = new ElementStyle(textColor, backColor);
            style.Class = ElementStyleClassKeys.ToolboxGroupTitleMouseOverKey;
            style.PaddingBottom = ToolboxGroupPadding;
            style.PaddingTop = ToolboxGroupPadding;
            style.PaddingLeft = ToolboxGroupPadding;
            style.PaddingRight = ToolboxGroupPadding;
        ...
        public static ElementStyle GetToolboxGroupExpandedTitle(Color textColor, Color backColor)
        {
            ElementStyle style = new ElementStyle(textColor, backColor);
            style.Class = ElementStyleClassKeys.ToolboxGroupExpandedTitleKey;
            style.PaddingBottom = ToolboxGroupPadding;
            style.PaddingTop = ToolboxGroupPadding;
            style.PaddingLeft = ToolboxGroupPadding;
            style.PaddingRight = ToolboxGroupPadding;
