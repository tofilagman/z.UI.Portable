...
namespace DevComponents.DotNetBar.Rendering
{
    internal static class Office2010SilverFactory
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.StyleClasses.Add(style.Class, style);
            // SideNavStrip
            style = Office2007ColorTableFactory.GetSideNavStripStyle(factory.GetColor(0xD5D8DC));
            table.StyleClasses.Add(style.Class, style);
            // TabFormPanel
            style = Office2007ColorTableFactory.GetTabFormPanelStyle(factory.GetColor(0xFEFEFE));
            table.StyleClasses.Add(style.Class, style);

            // Toolbox Control
            style = Office2007ColorTableFactory.GetToolboxControlStyle(factory.GetColor(table.LegacyColors.PanelBorder), Color.Empty);
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitle(factory.GetColor(0x2E2E2E));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(0x2E2E2E), factory.GetColor(0xFDE488));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(0x2E2E2E), factory.GetColor(Color.DarkGray));
            table.StyleClasses.Add(style.Class, style);
            #endregion
            ...
            table.StepItem.Default = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xFFFFFF), 
                    factory.GetColor(0xFBFBFC), 
                    factory.GetColor(0xFBFBFC), 
                    factory.GetColor(0xEDEFF1)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x2E2E2E),
                new Color[] {
                    factory.GetColor(0x8B9097) });
            ...
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xFDEEB3), 
                    factory.GetColor(0xFDE488),
                    factory.GetColor(0xFDE488), 
                    factory.GetColor(0xFDF8DE)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x2E2E2E),
                new Color[] {
                    factory.GetColor(0xF1CA58) });
            table.StepItem.Pressed = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xFBD678), 
                    factory.GetColor(0xFFE48A),
                    factory.GetColor(0xFFE48A), 
                    factory.GetColor(0xFEE287)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x2E2E2E),
                new Color[] {
                    factory.GetColor(0xC2762B) });
            #endregion

            #region TokenEditor
            table.TokenEditor = new TokenEditorColorTable(0x000000, 0xEBEDF2, 0x000000, 0xBBC2CB, 0xFFFFFF, 0x0072C6);
            #endregion
            ...
            #region SideNav
            table.SideNav.SideNavItem.Default = new SideNavItemStateColorTable(factory.GetColor(0x2E2E2E));
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(0x2E2E2E),
                new Color[]
                {
                    factory.GetColor(0xFBEDB3), factory.GetColor(0xF9E186), factory.GetColor(0xF9E186),
                    factory.GetColor(0xF8E496)
                },
                new Color[] { factory.GetColor(0xEEC958), factory.GetColor(0xF1D449) },
                0);
            table.SideNav.SideNavItem.Pressed = new SideNavItemStateColorTable(factory.GetColor(0x1E395B),
                new Color[]
                {
                    factory.GetColor(0xFBD678), factory.GetColor(0xFFE48A), factory.GetColor(0xFFE48A),
                    factory.GetColor(0xFEE287)
                },
                new Color[] { factory.GetColor(0xC2762B), factory.GetColor(0xF6C867) },
                0);
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(0x2E2E2E),
                new Color[] { table.Form.BackColor },
                new Color[] { Color.Empty, factory.GetColor(0xBABEC3), Color.Empty, factory.GetColor(0xBABEC3) });
            table.SideNav.BorderColors = new Color[] { factory.GetColor(0xBABEC3) };
            table.SideNav.TitleBackColor = factory.GetColor(0xE5E9EE);
            table.SideNav.TitleBorderColors = new Color[] { Color.Empty, Color.Empty, Color.Empty, factory.GetColor(0xBABEC3) };
            table.SideNav.PanelBackColor = table.Form.BackColor;

            #endregion

            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(0x2E2E2E);
            table.TabForm.Inactive.CaptionText = factory.GetColor(0x2E2E2E);
            table.TabForm.Active.CaptionBackColors = new Color[] { factory.GetColor(0xE3E6E8) };
            table.TabForm.Inactive.CaptionBackColors = new Color[] { factory.GetColor(0xE3E6E8) };
            ...
            table.TabFormItemColorTables.Add(TabFormItem.DefaultColorTableKey,
                ...
                new Color[] { factory.GetColor(0xFEFEFE) },
                new Color[] { factory.GetColor(0xBABEC3) },
                factory.GetColor(0x2E2E2E),
                new Color[] { factory.GetColor(0xFFFFFF), factory.GetColor(0xFEFEFE) },
                new Color[] { factory.GetColor(0xB6BABF)},
                factory.GetColor(0x2E2E2E)
                ));
