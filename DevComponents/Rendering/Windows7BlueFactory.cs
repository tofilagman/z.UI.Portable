...
namespace DevComponents.DotNetBar.Rendering
{
    ...
    public class Windows7BlueFactory
    {
        public static void InitializeBlueColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.StyleClasses.Add(style.Class, style);
            // TabFormPanel
            style = Office2007ColorTableFactory.GetTabFormPanelStyle(factory.GetColor(0xF7FBFF));
            table.StyleClasses.Add(style.Class, style);

            // Toolbox Control
            style = Office2007ColorTableFactory.GetToolboxControlStyle(factory.GetColor(table.LegacyColors.PanelBorder), Color.Empty);
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitle(factory.GetColor(0x254264));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(0x254264), factory.GetColor(0xFFECB5));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(0x254264), factory.GetColor(0xDCE7F5));
            table.StyleClasses.Add(style.Class, style);
            #endregion
            ...
            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(0x254264);
            table.TabForm.Inactive.CaptionText = factory.GetColor(0x254264);
            table.TabForm.Active.CaptionBackColors = new Color[] { factory.GetColor(0xDFE9F5) };
            table.TabForm.Inactive.CaptionBackColors = new Color[] { factory.GetColor(0xDFE9F5) };
            ...
            table.TabFormItemColorTables.Add(TabFormItem.DefaultColorTableKey,
                ...
                new Color[] { factory.GetColor(0xDFE9F5) },
                new Color[] { factory.GetColor(0xBAC9DB) },
                factory.GetColor(0x254264),
                new Color[] { factory.GetColor(0xFDFEFF), factory.GetColor(0xF7FBFF) },
                new Color[] { factory.GetColor(0xBAC9DB) },
                factory.GetColor(0x254264)
                ));
