...
namespace DevComponents.DotNetBar.Rendering
{
    internal static class Office2010BlackFactory
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.StyleClasses.Add(style.Class, style);
            // SideNavStrip
            style = Office2007ColorTableFactory.GetSideNavStripStyle(factory.GetColor(0xA3A3A3));
            table.StyleClasses.Add(style.Class, style);
            // TabFormPanel
            ...
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitle(factory.GetColor(0x242424));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(0x242424), factory.GetColor(0xFFE37C));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(0x242424), factory.GetColor(0xA3A3A3));
            table.StyleClasses.Add(style.Class, style);
            #endregion
            ...
            table.StepItem.Default = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xE2E2E2), 
                    factory.GetColor(0xD9D9D9), 
                    factory.GetColor(0xD9D9D9), 
                    factory.GetColor(0xC4C4C4)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x000000),
                new Color[] {
                    factory.GetColor(0x919191) });
            ...
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xFFEEA8), 
                    factory.GetColor(0xFFE37C),
                    factory.GetColor(0xFFE37C), 
                    factory.GetColor(0xFFFCE0)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x464646),
                new Color[] {
                    factory.GetColor(0xF7C840) });
            ...
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(0x000000),
                new Color[]
                {
                    factory.GetColor(0xFFEEA8), factory.GetColor(0xFFE37C), factory.GetColor(0xFFE37C),
                    factory.GetColor(0xFFFCE0)
                },
                new Color[] { factory.GetColor(0xF7C840), factory.GetColor(0xFFFFF0) },
                0);
            ...
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(0x000000),
                ...
                new Color[] { Color.Empty, factory.GetColor(0x5E5E5E), Color.Empty, factory.GetColor(0x5E5E5E) });
            table.SideNav.BorderColors = new Color[] { factory.GetColor(0x5E5E5E) };
            table.SideNav.TitleBackColor = factory.GetColor(0x4B4B4B);
            table.SideNav.TitleBorderColors = new Color[] { Color.Empty, Color.Empty, Color.Empty, factory.GetColor(0x5E5E5E) };
            table.SideNav.PanelBackColor = table.Form.BackColor;

            #endregion

            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(0xFFFFFF);
            table.TabForm.Inactive.CaptionText = factory.GetColor(0xFFFFFF);
            table.TabForm.Active.CaptionBackColors = new Color[] { factory.GetColor(0x717171) };
            table.TabForm.Inactive.CaptionBackColors = new Color[] { factory.GetColor(0x717171) };
            ...
            table.TabFormItemColorTables.Add(TabFormItem.DefaultColorTableKey,
                ...
                new Color[] { factory.GetColor(0x717171) },
                new Color[] { factory.GetColor(0x717171) },
                factory.GetColor(0xFFFFFF),
                new Color[] { factory.GetColor(0xCFCFCF), factory.GetColor(0xF5F6F7) },
                new Color[] { factory.GetColor(0x5E5E5E)},
                factory.GetColor(0x000000)
                ));
