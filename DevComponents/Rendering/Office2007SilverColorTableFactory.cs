...
namespace DevComponents.DotNetBar.Rendering
{
    ...
    internal class Office2007SilverColorTableFactory
    {
        ...
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.StyleClasses.Add(style.Class, style);
            // ListBoxAdv
            style = Office2007ColorTableFactory.GetListBoxAdvStyle(factory.GetColor(editoBorderColor));
            table.StyleClasses.Add(style.Class, style);
            ...
            table.StyleClasses.Add(style.Class, style);
            // SideNavStrip
            style = Office2007ColorTableFactory.GetSideNavStripStyle(table);
            table.StyleClasses.Add(style.Class, style);
            // TabFormPanel
            ...
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitle(factory.GetColor(0x333333));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(0x333333), factory.GetColor(0xD5DBE7));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(0x333333), factory.GetColor(Color.DarkGray));
            table.StyleClasses.Add(style.Class, style);           
            #endregion
            ...
            table.StepItem.Default = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xEBEEFA), 
                    factory.GetColor(0xD6DAE4), 
                    factory.GetColor(0xC5C7D1), 
                    factory.GetColor(0xD4D8E2)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x333333),
                new Color[] {
            ...
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                ...
                factory.GetColor(0x333333),
                new Color[] {
                    factory.GetColor(0xDDCF9B), factory.GetColor(0xFFF796) });
            table.StepItem.Pressed = new OfficeStepItemStateColorTable(new Color[]{
                ...
                factory.GetColor(0x333333),
                new Color[] {
                    factory.GetColor(0x8B7654), factory.GetColor(0xFDAD11) });
            #endregion
            ...
            #region SideNav
            table.SideNav.SideNavItem.Default = new SideNavItemStateColorTable(factory.GetColor(0x333333));
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(0x333333),
                new Color[]
                {
                    factory.GetColor(0xFFFBD7), factory.GetColor(0xFFE78D), factory.GetColor(0xFFD748),
                    factory.GetColor(0xFFE793)
                },
                new Color[] { factory.GetColor(0xC0A776), factory.GetColor(0xFFF2BE) },
                2);
            table.SideNav.SideNavItem.Pressed = new SideNavItemStateColorTable(factory.GetColor(0x333333),
                new Color[]
                {
                ...
                2);
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(0x333333),
            ...
            table.SideNav.TitleBackColor = factory.GetColor(0xE3E7EF);
