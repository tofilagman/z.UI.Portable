...
namespace DevComponents.DotNetBar.Rendering
{
    internal static class Office2010BlueFactory
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.StyleClasses.Add(style.Class, style);
            // SideNavStrip
            style = Office2007ColorTableFactory.GetSideNavStripStyle(factory.GetColor(0xBBCEE6));
            table.StyleClasses.Add(style.Class, style);
            // TabFormPanel
            ...
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitle(factory.GetColor(0x384E73));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(0x384E73), factory.GetColor(0xF8E496));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(0x384E73), factory.GetColor(0xD8E4F2));
            table.StyleClasses.Add(style.Class, style);
            #endregion
            ...
            table.StepItem.Default = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xE1EDFA), 
                    factory.GetColor(0xDCE8F5), 
                    factory.GetColor(0xDCE8F5), 
                    factory.GetColor(0xD0DFEE)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x000000),
                new Color[] {
                    factory.GetColor(0x1E395B) });
            ...
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xFBEDB3), 
                    factory.GetColor(0xF9E186),
                    factory.GetColor(0xF9E186), 
            ...
            #region TokenEditor
            table.TokenEditor = new TokenEditorColorTable(0x3B5371, 0xF2F8FE, 0x3B5371, 0xBBCEE6, 0xFFFFFF, 0x0072C6);
            #endregion
            ...
            #region SideNav
            table.SideNav.SideNavItem.Default = new SideNavItemStateColorTable(factory.GetColor(0x1E395B));
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(0x1E395B),
                new Color[]
                {
            ...
            table.SideNav.SideNavItem.Pressed = new SideNavItemStateColorTable(factory.GetColor(0x1E395B),
                ...
                0);
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(0x1E395B),
                new Color[] { table.Form.BackColor },
                new Color[] { Color.Empty, factory.GetColor(0x9FB2C7), Color.Empty, factory.GetColor(0x9FB2C7) });
            table.SideNav.BorderColors = new Color[] { factory.GetColor(0x9FB2C7) };
            table.SideNav.TitleBackColor = factory.GetColor(0xEFF6FD);
            table.SideNav.TitleBorderColors = new Color[] { Color.Empty, Color.Empty, Color.Empty, factory.GetColor(0x9FB2C7) };
            table.SideNav.PanelBackColor = table.Form.BackColor;

            #endregion

            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(0x1E395B);
            table.TabForm.Inactive.CaptionText = factory.GetColor(0x1E395B);
            table.TabForm.Active.CaptionBackColors = new Color[] { factory.GetColor(0xBBCEE6) };
            table.TabForm.Inactive.CaptionBackColors = new Color[] { factory.GetColor(0xBBCEE6) };
            ...
            table.TabFormItemColorTables.Add(TabFormItem.DefaultColorTableKey, 
                ...
                new Color[] { factory.GetColor(0xBBCEE6) }, 
                new Color[] { factory.GetColor(0xBBCEE6) },
                factory.GetColor(0x1E395B),
                new Color[] { factory.GetColor(0xF5FAFF), factory.GetColor(0xEFF6FD) },
                new Color[] { factory.GetColor(0xB8C9DB), factory.GetColor(0x9FB2C7) },
                factory.GetColor(0x1E395B)
                ));
