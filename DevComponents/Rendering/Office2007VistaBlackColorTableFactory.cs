...
namespace DevComponents.DotNetBar.Rendering
{
    public class Office2007VistaBlackColorTableFactory
    {
        ...
        public static void InitializeVistaBlackColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.StyleClasses.Add(style.Class, style);
            // SideNavStrip
            style = Office2007ColorTableFactory.GetSideNavStripStyle(factory.GetColor(0x3C4251));
            table.StyleClasses.Add(style.Class, style);
            // TabFormPanel
            ...
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupTitleMouseOver(factory.GetColor(0x000000), factory.GetColor(0xB5E4FF));
            table.StyleClasses.Add(style.Class, style);
            style = Office2007ColorTableFactory.GetToolboxGroupExpandedTitle(factory.GetColor(0xFFFFFF), factory.GetColor(0x616C76));
            table.StyleClasses.Add(style.Class, style);
            #endregion
            ...
            table.StepItem.Default = new OfficeStepItemStateColorTable(new Color[]{
                    ...
                    factory.GetColor(0xDBDBDB), 
                    factory.GetColor(0xDBDBDB), 
                    factory.GetColor(0xCDCFD2)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x000000),
                new Color[] {
                    factory.GetColor(0x8D949D) });
            ...
            table.StepItem.MouseOver = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xE9F7FE), 
                    factory.GetColor(0xDDF2FD),
                    factory.GetColor(0x95BED5), 
                    factory.GetColor(0xB5E4FF)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x000000),
                new Color[] {
                    factory.GetColor(0x959595), factory.GetColor(Color.FromArgb(128, Color.White)) });
            table.StepItem.Pressed = new OfficeStepItemStateColorTable(new Color[]{
                    factory.GetColor(0xE9F7FE), 
                    factory.GetColor(0xC5E9FB),
                    factory.GetColor(0x649EBF), 
                    factory.GetColor(0x87D3FF)
                    },
                    90,
                    new float[] { 0f, .5f, .5f, 1f },
                factory.GetColor(0x000000),
            ...
            #region SideNav
            table.SideNav.SideNavItem.Default = new SideNavItemStateColorTable(factory.GetColor(0xFFFFFF));
            table.SideNav.SideNavItem.MouseOver = new SideNavItemStateColorTable(factory.GetColor(0xFFFFFF),
                new Color[]
                {
                    factory.GetColor(0x9398AA), factory.GetColor(0x373E4A), factory.GetColor(0x111520),
                    factory.GetColor(0x566E91)
                },
                new Color[] { factory.GetColor(Color.FromArgb(128, Color.White)), factory.GetColor(0x153158) },
                0);
            table.SideNav.SideNavItem.Pressed = new SideNavItemStateColorTable(factory.GetColor(0xFFFFFF),
                new Color[]
                {
                    factory.GetColor(0x505976), factory.GetColor(0x344560), factory.GetColor(0x0F0F14),
                    factory.GetColor(0x192C4C)
                },
                new Color[] { factory.GetColor(Color.FromArgb(96, Color.White)), factory.GetColor(0x153158) },
                0);
            table.SideNav.SideNavItem.Selected = new SideNavItemStateColorTable(factory.GetColor(0x111216),
                new Color[] { table.Form.BackColor },
                new Color[] { Color.Empty, factory.GetColor(0x111216), Color.Empty, factory.GetColor(0x111216) });
            table.SideNav.BorderColors = new Color[] { factory.GetColor(0x111216) };
            table.SideNav.TitleBackColor = factory.GetColor(0x3C4251);
            table.SideNav.TitleBorderColors = new Color[] { Color.Empty, Color.Empty, Color.Empty, factory.GetColor(0x111216) };
            table.SideNav.PanelBackColor = table.Form.BackColor;

            #endregion

            #region TabForm
            table.TabForm.Active.CaptionText = factory.GetColor(0x4D5259);
            table.TabForm.Inactive.CaptionText = factory.GetColor(0x444444);
            ...
            table.TabFormItemColorTables.Add(TabFormItem.DefaultColorTableKey, Office2007ColorTable.CreateDefaultTabFormItemColorTable(factory, 0x333333));
