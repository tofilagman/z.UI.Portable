...
namespace DevComponents.DotNetBar
{
    ...
    public class TabColorScheme
    {
        ...
        private Color m_NavigationBoxForeColor = Color.Empty;
        private bool m_NavigationBoxForeColorCustom = false;
        /// <summary>
        /// Specifies the text of the tab item.
        /// </summary>
        [Browsable(true), DevCoBrowsable(true), System.ComponentModel.Category("Tab Control Colors"), System.ComponentModel.Description("Specifies foreground color of tab-strip navigation box.")]
        public Color NavigationBoxForeColor
        {
            get { return m_NavigationBoxForeColor; }
            set
            {
                if (m_NavigationBoxForeColor != value)
                {
                    m_NavigationBoxForeColor = value;
                    m_NavigationBoxForeColorCustom = true;
                    InvokeColorChanged();
                }
            }
        }
        [EditorBrowsable(EditorBrowsableState.Never)]
        public bool ShouldSerializeNavigationBoxForeColor()
        {
            return m_NavigationBoxForeColorCustom;
        }
        #endregion
