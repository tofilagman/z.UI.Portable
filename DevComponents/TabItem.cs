...
namespace DevComponents.DotNetBar
{
	...
	/// </summary>
    [Designer("DevComponents.DotNetBar.Design.TabItemDesigner, DevComponents.DotNetBar.Design, Version=14.1.0.25, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf"), ToolboxItem(false), ComVisible(false), DesignTimeVisible(false)]
	public class TabItem : Component, IBlock, ISimpleTab
	{
        ...
        private TabItemAccessibleObject _ItemAccessibleObject = null;
        protected virtual System.Windows.Forms.AccessibleObject CreateAccessibilityInstance()
        {
            if (_ItemAccessibleObject == null)
                _ItemAccessibleObject = new TabItemAccessibleObject(this);
		...
		internal Size IconSize
		{
			get
			{
				return new Size(Dpi.Width16,Dpi.Height16);
			}
		}
        ...
        internal void InvokeMouseDown(MouseEventArgs e)
        {
            if (MouseDown != null)
                MouseDown(this, e);
            if (m_DotNetBarItem != null && m_DotNetBarItem is DockContainerItem)
                m_DotNetBarItem.InternalMouseDown(e);
        }
        ...
        internal void InvokeMouseUp(MouseEventArgs e)
        {
            if (MouseUp != null)
                MouseUp(this, e);
            if (m_DotNetBarItem != null && m_DotNetBarItem is DockContainerItem)
                m_DotNetBarItem.InternalMouseUp(e);
        }
        ...
        internal void InvokeMouseEnter(EventArgs e)
        {
            if (MouseEnter != null)
                MouseEnter(this, e);
            if (m_Parent != null) m_Parent.OnTabMouseEnter(this, e);
        }
        ...
        internal void InvokeMouseLeave(EventArgs e)
        {
            if (MouseLeave != null)
                MouseLeave(this, e);
            if (m_Parent != null) m_Parent.OnTabMouseLeave(this, e);
        }
        ...
        internal void InvokeMouseHover(EventArgs e)
        {
            if (MouseHover != null)
                MouseHover(this, e);
            if (m_Parent != null) m_Parent.OnTabMouseHover(this, e);
        }
        ...
        internal void InvokeMouseMove(MouseEventArgs e)
        {
            if (MouseMove != null)
                MouseMove(this, e);
            if (m_Parent != null) m_Parent.OnTabMouseMove(this, e);
        }
