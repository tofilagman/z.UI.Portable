...
namespace DevComponents.Editors.DateTimeAdv
{
    public class MonthCalendarItem : CalendarBase
    {
        ...
        private void ApplyCommonProperties(SingleMonthCalendar m)
        {
            ...
            m.MonthSelectionMode = _MonthSelectionMode;
            m.MonthSelectorShortMonthNames = _MonthSelectorShortMonthNames;
        }
        ...
        /// </summary>
        [Localizable(true), Description("Indicates array of DayOfWeek members that determine which days of week to mark using Colors.WeeklyMarker settings. ")]
        ...
        /// </summary>
        [Localizable(true), Description("Indicates array of DateTime objects that determines which nonrecurring dates are marked using Colors.DayMarker settings.")]
        ...
        {
            get { return FirstCalendar.NavigationButtonSize; }
            set
            {
                foreach (BaseItem item in this.SubItems)
                {
        ...
        {
            return NavigationButtonSize.Width != SingleMonthCalendar._DefaultNavigationButtonSize.Width || NavigationButtonSize.Height != SingleMonthCalendar._DefaultNavigationButtonSize.Height;
        }
        /// <summary>
        /// Reset property to default value. Provided for designer support.
        /// </summary>
        ...
        {
            this.NavigationButtonSize = SingleMonthCalendar._DefaultNavigationButtonSize;
        }
        ...
        {
            if (m.MonthSelectionMode)
                m.SelectedDate = _SelectedDate;
            else if (m.DisplayMonth.Month == _SelectedDate.Month && m.DisplayMonth.Year == _SelectedDate.Year ||
        ...
        public bool MonthSelectorShortMonthNames
        {
            ...
            set
            {
                if (_MonthSelectorShortMonthNames != value)
                {
                    ...
                    foreach (BaseItem item in this.SubItems)
                    {
                        SingleMonthCalendar mc = item as SingleMonthCalendar;
                        if (mc != null)
                            mc.MonthSelectorShortMonthNames = _MonthSelectorShortMonthNames;
                    }
                }
            }
        }
            ...
            set
            {
                if (value != _MonthSelectionMode)
                {
                    ...
                    foreach (BaseItem item in this.SubItems)
                    {
                        SingleMonthCalendar mc = item as SingleMonthCalendar;
                        if (mc != null)
                            mc.MonthSelectionMode = _MonthSelectionMode;
                    }
                    NeedRecalcSize = true;
                    OnAppearanceChanged();
                }
