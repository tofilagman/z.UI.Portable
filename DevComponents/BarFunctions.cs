    ...
    public sealed class BarFunctions
    {
        ...
        internal static Bitmap LoadBitmap(string imageName)
        {
            ...
            if (att != null && att.NamespacePrefix != "")
            {
                ...
                return new Bitmap(typeof(z.UI.Extensions), $"DevComponents.{imageName}"); //typeof(DevComponents.DotNetBar.DotNetBarManager), imageName);
        }
        ...
        internal static Icon LoadIcon(string imageName)
        {
            ...
            if (att != null && att.NamespacePrefix != "")
            {
                ...
                return new Icon(typeof(z.UI.Extensions), $"DevComponents.{imageName}"); //DevComponents.DotNetBar.DotNetBarManager
        }
