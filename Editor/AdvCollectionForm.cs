...
{
    public abstract class AdvCollectionForm : Form
    {
        ...
        /// <summary>
        ///  Initializes a new instance of the <see cref='System.ComponentModel.Design.AdvCollectionEditor.CollectionForm'/> class.
        /// </summary>
        public AdvCollectionForm(AdvCollectionEditor editor)
        {
        ...
        /// </summary>
        public virtual bool CanSelectMultipleInstances() => _editor.CanSelectMultipleInstances();
        ...
        /// <summary>
        ///  This is called when the value property in the <see cref='System.ComponentModel.Design.AdvCollectionEditor.CollectionForm'/> has changed.
        /// </summary>
        public abstract void OnEditValueChanged();
    }
}
